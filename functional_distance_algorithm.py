...
/***************************************************************************
 DiscreteIsolation
                                 A QGIS plugin
 Calculates the Functional Distance
...
class FunctionalDistanceAlgorithm(QgsProcessingAlgorithm):
    ...
    def svgIconPath(self):
        return os.path.dirname(__file__) + '/functional_distance_icon.png'
        
    def shortHelpString(self):
        file = os.path.dirname(__file__) + '/functional_distance.help'
    ...
    def createInstance(self):
        return FunctionalDistanceAlgorithm()
